        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidEmailCheck", "Email LIKE '%@%'");
                    table.CheckConstraint("GymUserValidPhoneCheck", "Phone LIKE '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidEmailCheck1", "Email LIKE '%@%'");
                    table.CheckConstraint("GymUserValidPhoneCheck1", "Phone LIKE '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionCapacityCheck", "Capcity Between 1 and 25");
