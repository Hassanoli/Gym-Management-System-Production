...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20251017130328_RenameUpdatededAtToUpdatedAt")]
    partial class RenameUpdatededAtToUpdatedAt
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("GymUserValidPhoneCheck", "Phone LIKE '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Session", b =>
                {
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            t.HasCheckConstraint("SessionCapacityCheck", "Capcity Between 1 and 25");
